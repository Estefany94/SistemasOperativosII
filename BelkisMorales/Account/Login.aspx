    ...
    <div class="row">
            ...
            <section id="loginForm">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <asp:TextBox runat="server" ID="Domain" CssClass="form-control" TextMode="SingleLine" placeholder="Morales.com"/>
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="Domain"
                                CssClass="text-danger" ErrorMessage="El dominio es obligatorio." />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="Username"
                                CssClass="text-danger" ErrorMessage="El nombre de usuario es obligatorio." />
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <%--
                <p>
                    NO QUIERO REGISTRAR USUARIOS NUEVOS
                ...
                <p>
                    ...
                    <asp:HyperLink runat="server" ID="ForgotPasswordHyperLink" ViewStateMode="Disabled" class="col-md-offset-2 col-md-10">Recuperar contraseña</asp:HyperLink>
        ...
        <div class="col-md-4">
            <section id="socialLoginForm" style="font-weight: bold; font-size: x-large">
                <br /><br /><br /><br /><br /><br />
                <asp:label id="errorLabel" runat="server" class="text-danger"/>
                <%-- <asp:TextBox runat="server" ID="errorLabel" TextMode="MultiLine" CssClass="form-control" class="col-md-10"/> --%>
            </section>
        </div>
    </div>
</asp:Content>
